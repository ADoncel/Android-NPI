...
public class Brujula extends Activity implements SensorEventListener {
	...
	/**
	 * Acción al pulsar S: Selecciona el Sur como objetivo
	 * @param v
	 */
	...
	/**
	 * Acción al pulsar SO: Selecciona el Suroeste como objetivo
	 * @param v
	 */
	...
	/**
	 * Acción al pulsar O: Selecciona el Oeste como objetivo
	 * @param v
	 */
	...
	/**
	 * Restaura los parámetros de los botones
	 * @param valor
	 */
	...
	/**
	 * Método que se ejecuta continuamente con el cambio en los sensores.
	 * Si se ha seleccionado un punto cardinal y se a puesto el móvil
	 * en dicha orientación se lanzará la camara.
	 * @param event
	 */
	@Override
